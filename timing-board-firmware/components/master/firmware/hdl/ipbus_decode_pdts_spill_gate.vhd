...
package ipbus_decode_pdts_spill_gate is

  constant IPBUS_SEL_WIDTH: positive := 2;
  subtype ipbus_sel_t is std_logic_vector(IPBUS_SEL_WIDTH - 1 downto 0);
  function ipbus_sel_pdts_spill_gate(addr : in std_logic_vector(31 downto 0)) return ipbus_sel_t;
...
end ipbus_decode_pdts_spill_gate;

package body ipbus_decode_pdts_spill_gate is

  function ipbus_sel_pdts_spill_gate(addr : in std_logic_vector(31 downto 0)) return ipbus_sel_t is
...
-- END automatically generated VHDL
  ...
  end function ipbus_sel_pdts_spill_gate;
